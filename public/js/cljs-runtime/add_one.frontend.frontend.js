...
return ajax.core.GET.cljs$core$IFn$_invoke$arity$variadic("http://localhost:3000/api/counter",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"handler","handler",-195596612),(function (p1__22552_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(add_one.frontend.frontend.app_state,cljs.core.assoc,new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(p1__22552_SHARP_));
}),new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),(function (p1__22554_SHARP_){
return console.error("Error:",p1__22554_SHARP_);
})], null)], 0));
});
add_one.frontend.frontend.add_one = (function add_one$frontend$frontend$add_one(){
return ajax.core.POST.cljs$core$IFn$_invoke$arity$variadic("http://localhost:3000/api/increment",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"handler","handler",-195596612),(function (p1__22556_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(add_one.frontend.frontend.app_state,cljs.core.assoc,new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(p1__22556_SHARP_));
}),new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),(function (p1__22557_SHARP_){
return console.error("Error:",p1__22557_SHARP_);
})], null)], 0));
});
add_one.frontend.frontend.app = (function add_one$frontend$frontend$app(){
var map__22563 = cljs.core.deref(add_one.frontend.frontend.app_state);
var map__22563__$1 = cljs.core.__destructure_map(map__22563);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22563__$1,new cljs.core.Keyword(null,"value","value",305978217));
