...
var G__22410 = request;
var G__22411 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__22410,G__22411) : ajax.formats.get_format.call(null,G__22410,G__22411));
} else {
...
return cljs.core.some((function (p1__22420_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__22420_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__22422){
var map__22425 = p__22422;
var map__22425__$1 = cljs.core.__destructure_map(map__22425);
var request = map__22425__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22425__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__22429 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__22429.cljs$core$IFn$_invoke$arity$1 ? fexpr__22429.cljs$core$IFn$_invoke$arity$1(response) : fexpr__22429.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__22431){
var map__22432 = p__22431;
var map__22432__$1 = cljs.core.__destructure_map(map__22432);
var request = map__22432__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22432__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__22430_SHARP_){
return ajax.formats.get_accept_entries(request,p1__22430_SHARP_);
