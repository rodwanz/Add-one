...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__22462 = cljs.core.second(format);
var G__22463 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__22462,G__22463) : ajax.easy.keyword_response_format_element.call(null,G__22462,G__22463));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22465_SHARP_){
return ajax.easy.keyword_response_format_element(p1__22465_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__22471){
var map__22472 = p__22471;
var map__22472__$1 = cljs.core.__destructure_map(map__22472);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22472__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22472__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22472__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__22473){
var vec__22474 = p__22473;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22474,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22474,(1),null);
var fexpr__22477_22483 = (cljs.core.truth_(ok)?h:e);
(fexpr__22477_22483.cljs$core$IFn$_invoke$arity$1 ? fexpr__22477_22483.cljs$core$IFn$_invoke$arity$1(result) : fexpr__22477_22483.call(null,result));
 ...
 */
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__22478){
var map__22479 = p__22478;
var map__22479__$1 = cljs.core.__destructure_map(map__22479);
var opts = map__22479__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22479__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22479__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22479__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22479__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22479__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
