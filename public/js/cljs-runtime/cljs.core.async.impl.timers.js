...
var i_14302 = (self__.level + (1));
while(true){
if((i_14302 <= (new_level + (1)))){
(update[i_14302] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_14304 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14304[i]));
} else {
x__$2.forward.push((((i < links_14304.length))?(links_14304[i]):null));
}

if((i < links_14304.length)){
(links_14304[i] = x__$2);
} else {
links_14304.push(x__$2);
}
...
var i_14307 = (0);
while(true){
if((i_14307 <= self__.level)){
var links_14309 = (update[i_14307]).forward;
if((x__$1 === (((i_14307 < links_14309.length))?(links_14309[i_14307]):null))){
(links_14309[i_14307] = (x__$1.forward[i_14307]));

var G__14311 = (i_14307 + (1));
i_14307 = G__14311;
continue;
} else {
var G__14313 = (i_14307 + (1));
i_14307 = G__14313;
continue;
}
} else {
