...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21591 = c;
var G__21591__$1 = (((G__21591 == null))?null:G__21591.prototype);
if((G__21591__$1 == null)){
return null;
} else {
return G__21591__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21593 = c;
var G__21593__$1 = (((G__21593 == null))?null:G__21593.prototype);
if((G__21593__$1 == null)){
return null;
} else {
return G__21593__$1.render;
}
})() == null)))));
});
...
var or__5142__auto__ = (function (){var G__21609 = c;
var G__21609__$1 = (((G__21609 == null))?null:G__21609.constructor);
if((G__21609__$1 == null)){
return null;
} else {
return G__21609__$1.displayName;
}
})();
...
var G__21611 = c;
var G__21611__$1 = (((G__21611 == null))?null:G__21611.constructor);
if((G__21611__$1 == null)){
return null;
} else {
return G__21611__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__21638 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21639 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21639);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21638);
}});
...
var c = this;
var G__21650_22036 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__21650_22036 == null)){
} else {
reagent.ratom.dispose_BANG_(G__21650_22036);
}
...
var renders_22037 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_22038 = cljs.core.first(cljs.core.vals(renders_22037));
...
if((cljs.core.count(renders_22037) > (0))){
} else {
throw (new Error((""+"Assert failed: "+"Missing reagent-render"+"\n"+"(pos? (count renders))")));
}

if(((1) === cljs.core.count(renders_22037))){
} else {
throw (new Error((""+"Assert failed: "+"Too many render functions supplied"+"\n"+"(== 1 (count renders))")));
}

if(cljs.core.ifn_QMARK_(render_fun_22038)){
} else {
throw (new Error((""+"Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1((""+"Expected something callable, not "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_22038], 0)))))+"\n"+"(clojure.core/ifn? render-fun)")));
}
...
var G__21743 = o;
reagent.impl.component.goog$module$goog$object.set(G__21743,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__22017 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22018 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22018);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22017);
}});
...
var vec__22019 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22019,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22019,(1),null);
...
var G__22022 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__22022 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__22022);
}
});
}),[]);
